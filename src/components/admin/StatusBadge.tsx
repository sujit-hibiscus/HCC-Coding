...
const statusConfig: Record<string, { color: string; icon: React.ReactNode }> = {
    ...
    [DOCUMENT_STATUS.ON_HOLD]: {
        color: "bg-green-400 hover:text-white text-black border-green-700 hover:bg-green-700",
        icon: ""
    },
    [DOCUMENT_STATUS.In_Review]: {
        color: "bg-blue-300 text-black border-blue-500 hover:bg-blue-400 hover:text-white",
        icon: ""
    },
    ...
    [DOCUMENT_STATUS.COMPLETED]: {
        color: "bg-green-200 border-green-700 hover:text-white text-black hover:bg-green-500",
        icon: ""
    },
};
